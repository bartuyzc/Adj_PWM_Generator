...
set_property PACKAGE_PIN U18 [get_ports {inc_duty}]
set_property IOSTANDARD LVCMOS33 [get_ports {inc_duty}]
#Bank = 14, Pin name = ,					Sch name = BTNU
set_property PACKAGE_PIN T18 [get_ports {dec_duty}]
set_property IOSTANDARD LVCMOS33 [get_ports {dec_duty}]
#Bank = 14, Pin name = ,	Sch name = BTNL
set_property PACKAGE_PIN W19 [get_ports {inc_freq}]
set_property IOSTANDARD LVCMOS33 [get_ports {inc_freq}]
#Bank = 14, Pin name = ,							Sch name = BTNR
set_property PACKAGE_PIN T17 [get_ports {dec_freq}]
set_property IOSTANDARD LVCMOS33 [get_ports {dec_freq}]
